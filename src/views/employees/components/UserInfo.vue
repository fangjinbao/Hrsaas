...
export default {
  ...
  methods: {
    ...
    async getUserDetailById() {
      ...
      if (this.userInfo.staffPhoto && this.userInfo.staffPhoto.trim()) this.$refs.staffPhoto.fileList = [{ url: this.userInfo.staffPhoto, upload: true }]
    },
    // 保存基本信息
    async saveUser() {
    ...
    async getPersonalDetail() {
      ...
      if (this.formData.staffPhoto && this.formData.staffPhoto.trim()) this.$refs.myStaffPhoto.fileList = [{ url: this.formData.staffPhoto, upload: true }]
    },
    // 保存员工详情
    async savePersonal() {
